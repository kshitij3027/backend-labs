...
IP_POOL = [f"10.0.{random.randint(1, 5)}.{i}" for i in range(1, 11)] + [
    # Public IPs for geographic diversity
    "8.8.8.8", "1.1.1.1", "203.0.113.50", "198.51.100.25",
    "185.70.40.1", "103.21.244.5", "177.71.128.10", "91.198.174.1",
    "45.33.32.156", "104.16.132.229",
]
