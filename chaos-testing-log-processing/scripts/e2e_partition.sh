#!/usr/bin/env bash
# E2E smoke for the NETWORK_PARTITION fault type.
...
echo "==> running partition driver inside chaos-framework"
set +e
docker exec chaos-framework python3 /app/scripts/e2e_partition.py
rc=$?
set -e
