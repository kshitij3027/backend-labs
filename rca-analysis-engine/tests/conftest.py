...
no startup work, no background live-stream loop — so tests exercise the HTTP surface
hermetically.
"""
...
@pytest.fixture()
def app():
    """A FastAPI app wired to a fresh Runtime (lifespan skipped, live loop off)."""
