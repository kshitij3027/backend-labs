"""Simple HTTP dashboard for server metrics."""
...
class DashboardHandler(BaseHTTPRequestHandler):
    ...
    metrics = None  # Set by DashboardServer
    adaptive = None  # Optional, set by DashboardServer
    ...
    def _serve_stats(self):
        ...
        if self.adaptive:
            stats["cpu_percent"] = self.adaptive.current_cpu
...
<html>
<head>
    <title>Log Compression Dashboard</title>
    <style>
...
class DashboardServer:
    ...
    def __init__(self, port: int = 8080, metrics=None, adaptive=None):
        self._port = port
        DashboardHandler.metrics = metrics
        DashboardHandler.adaptive = adaptive
        self._httpd = None
        self._thread = None
